...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(1660, 11);
			...
			this->label2->Location = System::Drawing::Point(343, 245);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(289, 46);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Gill Sans Ultra Bold Condensed", 20.25F, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(1079, 245);
			...
			this->piePrices->ChartAreas->Add(chartArea5);
			legend5->Name = L"Legend1";
			this->piePrices->Legends->Add(legend5);
			this->piePrices->Location = System::Drawing::Point(15, 293);
			this->piePrices->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->piePrices->Name = L"piePrices";
			series5->ChartArea = L"ChartArea1";
			series5->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::Pie;
			series5->Legend = L"Legend1";
			series5->Name = L"Precios ($)";
			this->piePrices->Series->Add(series5);
			this->piePrices->Size = System::Drawing::Size(625, 464);
			...
			this->LeftFoodchart->ChartAreas->Add(chartArea6);
			legend6->Name = L"Legend1";
			this->LeftFoodchart->Legends->Add(legend6);
			this->LeftFoodchart->Location = System::Drawing::Point(661, 293);
			this->LeftFoodchart->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			series6->Name = L"Cantidad restante (kg)";
			this->LeftFoodchart->Series->Add(series6);
			this->LeftFoodchart->Size = System::Drawing::Size(1149, 464);
